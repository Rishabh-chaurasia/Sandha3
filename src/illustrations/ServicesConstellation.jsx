...
export default function ServicesConstellation({ className = '' }) {
  return <div role="img" aria-label="Sandha and Company services" className={`${className} relative isolate flex min-h-[350px] items-end overflow-hidden sm:min-h-[420px]`}>
