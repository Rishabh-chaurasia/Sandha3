...
export default function CompanyFoundation({ className = '' }) {
  return (
    <Stage viewBox="0 0 520 380" className={className} label="Company foundation: people, process and technology connect to dependable service for clients">
      ...
      <G v="rise" delay={1.05}>
        ...
        <text x="226" y="286" fill={K.ink} fontSize="18" fontWeight="800">Dependable</text>
