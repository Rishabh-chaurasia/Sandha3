...
export default function Services() {
  return (
    <>
      ...
      <PageHero
        tone="lines"
        sectionClassName="min-h-[720px] !pb-10 !pt-[112px] sm:!pb-12 sm:!pt-[124px] lg:!pb-[96px] lg:!pt-[80px] lg:min-h-[720px]"
        align="center"
        eyebrow="OUR SERVICES"
        title="Field teams, people and technology for utilities"
        lead="Services built around jobs: registering a consumer complaint, getting a trained team to the fault and resolving it on the ground."
        leadClassName="!text-[#1f2d44] font-medium"
