...
const PHOTOS = [
  ...
  { src: '/photos/hero/lifting-utility-crew.png', alt: 'Utility crew using a vehicle-mounted lifting platform for overhead-line maintenance', caption: 'Trolley-mounted lifters' },
